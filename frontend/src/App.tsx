          ...
          <main>
            <Routes>
              ...
              <Route element={<RotaPrivada />}>
                ...
                <Route
                  path="/associados/:id"
                  element={<AssociadoDetalhado />}
                />
                <Route
                  path="/cadastrarAssociado"
                  element={<CadastrarAssociado />}
                />
                <Route
                  path="/editarAssociado/:id"
                  element={<EditarAssociado />}
                />
                <Route
                  path="/enderecosDoAssociado/:id"
                  element={<EnderecosDoAssociado />}
                />
                <Route
                  path="/anotacoesDoAssociado/:id"
                  element={<AnotacoesDoAssociado />}
                />
                <Route
                  path="/telefonesDoAssociado/:id"
                  element={<TelefonesDoAssociado />}
                />
                <Route
                  path="/associado/:id/enderecos"
                  element={<CadastrarEndereco />}
                />
                <Route
                  path="/associado/:id/telefones"
                  element={<CadastrarTelefone />}
                />
                <Route
                  path="/associado/:id/anotacoes"
                  element={<CadastrarAnotacao />}
                />
